...
router.post('/register', async (req, res) => {
  try {
    ...
    // Public registration is limited to end-user roles. Admins must be created through
    // the controlled seed/admin provisioning path, not by trusting request input.
